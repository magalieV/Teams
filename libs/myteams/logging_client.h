...
/*!
    \param thread_id a character pointer corresponding to the universally
    unique id assigned to the thread in the team.
    \param user_id a character pointer corresponding to the universall
...
//! Handler called when the user ask for a specific thread (/list
//! CLI command), used in a loop over each reply
/*!
    \param thread_id a character pointer corresponding to the universally
...
/*!
    ...
    \param timestamp an unsigned integer corresponding to the timestamp of
    the message.
    \param message a character pointer corresponding to the message.
    \return On success, 1 is returned. On error, -1 is returned and errno is
    set appropriately
